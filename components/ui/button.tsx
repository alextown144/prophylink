...
const buttonVariants = cva(
  "focus-ring inline-flex items-center justify-center gap-2 rounded-lg text-sm font-semibold transition-colors disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-[#00B3A4] text-white shadow-sm hover:bg-[#008F85]",
        outline: "border border-[#6D28D9] bg-white text-[#6D28D9] hover:bg-[#F3E8FF]",
        ghost: "text-[#0B132B] hover:bg-slate-100"
      },
      size: {
